#ifndef _LEPTOBJECTPOOL_HPP_
#define _LEPTOBJECTPOOL_HPP_
#include<stdlib.h>
#include<assert.h>
#include<mutex>
...
private:
    //
    typedef LeptObjectPool<Type, nPoolSzie> ClassTypePool;
    //
